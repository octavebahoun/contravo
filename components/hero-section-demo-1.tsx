 ...
 * money, et le cachet qui bascule d'EN ATTENTE à SIGNÉ au clic (et joue son
 * impact une première fois à l'entrée dans le viewport).
 */
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-border pb-4">
          ...
          <button
            ...
            className="group flex cursor-pointer flex-col items-end gap-1 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-card"
            aria-label={
              signed
        ...
        <div className="flex items-baseline justify-between border-t border-border pt-4">
          ...
          <span className="tabular-mono text-lg font-semibold text-accent">
            {total} XOF
          </span>
        </div>
      </motion.div>
